            ...
            <Col md="10" className="ml-auto pt-2 mr-auto" style={styles.background}>
                <Row>
                    <Col className="p-2" lg="6">
                        {
                            (item.backdrop_path) ? (<Image className="ml-2" src={`https://image.tmdb.org/t/p/w500${item.backdrop_path}`} fluid/>) :
                                (<Image className="ml-2" src="https://edge-cdn.pratidintime.com/2019/08/Manipur-Cinema-Policy.jpg" fluid/>)
                        }
                                ...
                                {cast.map((actor) => {
                                    return (<Col key={actor.id}>
                                        <Card className="p-1" style={styles.background2}>
                                            ...
                                            <CardTitle className="mt-2" style={styles.colorW}>{actor.name}</CardTitle>
                                        </Card>
                                    </Col>)
                                })}
                            </Carousel>)
                ...
                <Col style={styles.background2} className="mt-2">
                    <Row className="pt-2">
                        ...
                        <Col>
                            <p className="ml-auto" style={styles.paragraph}><i style={styles.icon} className="fas fa-bookmark fa-lg"></i> Watch List </p>
                        </Col>
                    </Row>
                    <Col>
                ...
                <Row className="mt-3 pb-3">
                    {
                        (similarMovies[0] === undefined) ? (<Col className="App mt-3"><h3 style={styles.colorW}>There is no Similar Movies Found</h3></Col>)
                            : similarMovies.map(movie => {
                                return( <Col key={movie.id}>
                                    <Card className="p-1" style={styles.background2}>
                                        <Link  to={`/movies1/${movie.id}`}>
